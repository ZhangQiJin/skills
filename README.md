...
| `mobile-native-reverse-ui-analysis` | Reverse-engineers UI inputs such as HTML analysis results, screenshots, design notes, or layout snippets into 12-dimension native mobile specs, then outputs one-shot prompts for iOS SwiftUI/UIKit and Android Jetpack Compose/XML. Includes a usage guide and demo recording. |
