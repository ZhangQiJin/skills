...
| `mobile-native-reverse-ui-analysis` | 移动原生 UI 逆向分析技能，可将 HTML 分析结果、截图、设计说明或布局片段转换为 iOS SwiftUI/UIKit 与 Android Jetpack Compose/XML 的 12 维原生规格说明，并输出双端一键生成提示词。附带详细使用说明和录屏演示。 |
